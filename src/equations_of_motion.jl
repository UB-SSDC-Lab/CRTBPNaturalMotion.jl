...
function natural_crtbp_eom_with_stm(z, p, t)
    # Grab states
    rx = z[1,1]; ry = z[2,1]; rz = z[3,1]
    vx = z[4,1]; vy = z[5,1]; vz = z[6,1]
    ...
    return SMatrix{6,7}(
        ...
        dSTM[1],  dSTM[2],  dSTM[3],  dSTM[4],  dSTM[5],  dSTM[6],
        dSTM[7],  dSTM[8],  dSTM[9],  dSTM[10], dSTM[11], dSTM[12],
        dSTM[13], dSTM[14], dSTM[15], dSTM[16], dSTM[17], dSTM[18],
        dSTM[19], dSTM[20], dSTM[21], dSTM[22], dSTM[23], dSTM[24],
        dSTM[25], dSTM[26], dSTM[27], dSTM[28], dSTM[29], dSTM[30],
        dSTM[31], dSTM[32], dSTM[33], dSTM[34], dSTM[35], dSTM[36],
    )
end
